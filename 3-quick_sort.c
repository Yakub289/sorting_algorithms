...
/**
* partition - locates the partition for the quicksort using the Lomuto scheme
...
/**
* quicksort - sorts a partition of  array of integers
* @array: array to sort
...
/**
 * quick_sort - Write a function that sorts an array of integers
